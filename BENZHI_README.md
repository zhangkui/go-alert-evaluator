...
./build_benzhi_docker.sh go-alert-evaluator-bug4-candidate linux/amd64
./build_benzhi_docker.sh go-alert-evaluator-bug4-candidate linux/arm64
docker run --rm -it --platform linux/amd64 go-alert-evaluator-bug4-candidate bash
docker run --rm -it --platform linux/arm64 go-alert-evaluator-bug4-candidate bash
```
